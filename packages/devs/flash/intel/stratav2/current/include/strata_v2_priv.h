#ifndef CYGONCE_DEVS_FLASH_INTEL_STRATA_V2_STRATA_PRIV_H
#define CYGONCE_DEVS_FLASH_INTEL_STRATA_V2_STRATA_PRIV_H
//==========================================================================
//
//      strata_priv.h
//
...
// ------------------------------------------------------------------------
// 
// It is expected that the source file including flash_strata.inl
// defined all the properties of the device we want to drive: the
// choices this module supports include:
//
//                                    Buffered  Read     Block
//                                     write    query    locking
...
// 
// These options are controlled by defining or not, in the source file,
// these symbols (not CDL options, just symbols)
...
//         CYGNUM_FLASH_INTERLEAVE 	number of devices across the databus
...
// 4x8bit devices; usually 16bit ones are chosen in practice, so we
// would have CYGNUM_FLASH_INTERLEAVE = 2, and CYGNUM_FLASH_WIDTH =
// 16.  Both devices would be handled simulataneously, via 32bit bus
// operations.  Some CPUs can handle a single 16bit device as 32bit
// memory "by magic".  In that case, CYGNUM_FLASH_INTERLEAVE = 1 and
// CYGNUM_FLASH_WIDTH = 16, and the device is managed using only 16bit
// bus operations.
...
#endif  // CYGONCE_DEVS_FLASH_INTEL_STRATA_V2_STRATA_PRIV_H
// ------------------------------------------------------------------------
// EOF strata.h 
