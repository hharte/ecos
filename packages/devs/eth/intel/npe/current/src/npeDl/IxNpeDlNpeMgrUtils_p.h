...
/**
 * @fn void ixNpeDlNpeMgrDebugInstructionExec (UINT32 npeBaseAddress,
 ...
 * 
 * @brief Clean up after executing one or more PSM instructions in the
 *        Debug Stack Level
 *
 * @param UINT32 [in] npeBaseAddress - Base Address of NPE
 * 
 ...
 * *Note that CSR1.0 supports 32 physical registers, but 64 may be supported in
 * future versions.
 * 
 * @pre
 *    - The NPE should be stopped and in a clean state
